export const tools = [
    ...
    },
    {
        ...
        description: 'Stage or complete a Resy table booking. First call (confirm=false/omitted) when the user says book/reserve with a time — returns a confirmation SMS; do not book yet. Second call (confirm=true) only after they reply yes to that confirmation. Use venue_id from the latest search.',
        input_schema: {
            type: 'object',
            properties: {
                venue_id: {
                ...
                confirm: {
                    type: 'boolean',
                    description: 'Set true only after the user replied yes to a "Just to confirm" message. Omit or false on the first book request.',
                },
            },
